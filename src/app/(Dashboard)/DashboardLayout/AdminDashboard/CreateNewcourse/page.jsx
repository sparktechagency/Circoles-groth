  ...
  return (
    <div className='bg-white h-screen'>
      ...
      >
        ...
        >
          <Input style={{ height: '44px', fontSize: '16px' }} placeholder="Your course title" />
        </Form.Item>
        ...
        >
          <Input style={{ height: '44px', fontSize: '16px' }} placeholder="Your course subtitle" />
        </Form.Item>
        ...
        <Form.Item
          label="Pricing"
          name="pricing"
          rules={[{ required: true, message: "Please select the pricing" }]}
        >
          <Select
            placeholder="Select..."
        ...
        {/* Platform Fees */}
        <Form.Item label="Platform Fees" name="platformFees" initialValue="20%">
        ...
        >
          <Input style={{ height: '44px', fontSize: '16px' }} placeholder="What is primarily taught in your course?" />
        </Form.Item>
