...
const Page = () => {
  ...
  const onFinish = (values) => {
    ...
    const allnidData = {
      "id_card[type]": values["id_card[type]"],
      "id_card[front_side]":
        values["id_card[front_side]"]?.[0]?.originFileObj || null,
      "id_card[back_side]":
        values["id_card[back_side]"]?.[0]?.originFileObj || null,
    };

    updateFormData(allnidData);
    router.push("/TutorDashboard/Verification/verificationStep3");
  };
      ...
      >
        ...
        <Form.Item
          ...
          rules={[
            {
              required: true,
              message: "Please select your academic certificate!",
            },
          ]}
        >
          <Select
            ...
            className="w-full"
          >
            <Option value="passport">Passprot</Option>
