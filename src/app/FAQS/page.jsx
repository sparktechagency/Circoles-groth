    ...
    return (
        <div className="container mx-auto my-10 p-4 bg-white   rounded">
            ...
            <Collapse defaultActiveKey={['1']} accordion>
                <Panel  className='text-gray-700 text-xl' header="What is Pantognostis?" key="1">
                    <p>
                ...
                <Panel className='text-gray-700 text-xl' header="How can I enroll in a course?" key="2">
                    <p>
                ...
                <Panel className='text-gray-700 text-xl' header="What payment methods are accepted?" key="3">
                    <p>
                        We accept payments through credit/debit cards, PayPal, and direct bank transfers. 
                        All payments are processed securely through our payment partners.
                    </p>
                </Panel>
                <Panel className='text-gray-700 text-xl' header="Can I access the course materials after completion?" key="4">
                    <p>
                ...
                <Panel className='text-gray-700 text-xl' header="What is the refund policy?" key="5">
                    <p>
                ...
                <Panel className='text-gray-700 text-xl' header="How do I contact support?" key="6">
                    <p>
                ...
                <Panel className='text-gray-700 text-xl' header="Can I switch between courses?" key="7">
                    <p>
                ...
                <Panel className='text-gray-700 text-xl' header="Do you provide certificates?" key="8">
                    <p>
