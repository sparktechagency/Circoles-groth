        ...
        <div className="p-4">
          ...
          <div className="flex items-center justify-between text-[#475467] text-sm pb-4 ">
            <span className="mr-4 flex items-center font-medium text-lg">
              ...
              >
                <path
                  d="M1.3335 12.0996L8.00016 15.4329L14.6668 12.0996M1.3335 8.76628L8.00016 12.0996L14.6668 8.76628M8.00016 2.09961L1.3335 5.43294L8.00016 8.76628L14.6668 5.43294L8.00016 2.09961Z"
                  stroke="#475467"
                  stroke-linecap="round"
                  stroke-linejoin="round"
                />
              </svg>
              <span className="text-[#475467] pl-2">
