...
const cardData = [
  ...
  },
  {
    ...
    <path opacity="0.2" d="M30.3335 18C27.9061 18 25.5357 18.7362 23.5354 20.1114C21.5351 21.4866 19.9988 23.436 19.1295 25.7025C18.2601 27.9689 18.0986 30.4457 18.6661 32.8058C19.2337 35.166 20.5036 37.2985 22.3084 38.9219V38.9217C23.0613 37.4405 24.2096 36.1966 25.6261 35.3279C27.0425 34.4592 28.6719 33.9996 30.3335 34C29.3446 34 28.3779 33.7068 27.5556 33.1573C26.7334 32.6079 26.0925 31.827 25.7141 30.9134C25.3357 29.9998 25.2366 28.9945 25.4296 28.0245C25.6225 27.0546 26.0987 26.1637 26.798 25.4645C27.4972 24.7652 28.3881 24.289 29.358 24.0961C30.328 23.9031 31.3333 24.0022 32.2469 24.3806C33.1605 24.759 33.9414 25.3999 34.4908 26.2221C35.0403 27.0444 35.3335 28.0111 35.3335 29C35.3335 30.3261 34.8067 31.5978 33.869 32.5355C32.9313 33.4732 31.6596 34 30.3335 34C31.9951 33.9996 33.6245 34.4592 35.0409 35.3279C36.4574 36.1966 37.6057 37.4405 38.3586 38.9217C40.1634 37.2984 41.4333 35.1658 42.0009 32.8057C42.5684 30.4456 42.4069 27.9688 41.5375 25.7024C40.6682 23.436 39.1319 21.4865 37.1316 20.1113C35.1313 18.7362 32.7609 18 30.3335 18Z" fill="#475467"/>
    <path d="M30.3335 42C36.9609 42 42.3335 36.6274 42.3335 30C42.3335 23.3726 36.9609 18 30.3335 18C23.7061 18 18.3335 23.3726 18.3335 30C18.3335 36.6274 23.7061 42 30.3335 42Z" stroke="#475467" stroke-width="2" stroke-miterlimit="10"/>
    <path d="M30.3335 34C33.0949 34 35.3335 31.7614 35.3335 29C35.3335 26.2386 33.0949 24 30.3335 24C27.5721 24 25.3335 26.2386 25.3335 29C25.3335 31.7614 27.5721 34 30.3335 34Z" stroke="#475467" stroke-width="2" stroke-miterlimit="10"/>
    <path d="M22.3086 38.9218C23.0619 37.4408 24.2102 36.1971 25.6266 35.3284C27.043 34.4598 28.6722 34 30.3337 34C31.9952 34 33.6244 34.4598 35.0408 35.3284C36.4572 36.1971 37.6055 37.4407 38.3588 38.9217" stroke="#475467" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
    </svg>
